...
export default class ArticleService {
  find(id: number): Promise<IArticle> {
  ...
  create(entity: IArticle): Promise<IArticle> {
    return new Promise<IArticle>((resolve, reject) => {
      axios
  ...
  update(entity: IArticle): Promise<IArticle> {
    return new Promise<IArticle>((resolve, reject) => {
      axios
  ...
  partialUpdate(entity: IArticle): Promise<IArticle> {
    return new Promise<IArticle>((resolve, reject) => {
      axios
