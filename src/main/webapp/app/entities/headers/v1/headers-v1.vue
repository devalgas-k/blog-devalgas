<template>
  <b-navbar data-cy="navbar" toggleable="md" type="dark" class="headers-v1 bg-primary py-0 mt-1">
    ...
    <b-collapse is-nav id="header-tabs">
          ...
          <b-nav-item-dropdown id="contactUsnavBarDropdown" ref="contactDropdown" class="mx-md-1" v-if="!authenticated">
            <template #button-content>
              <span class="navbar-dropdown-menu">
                ...
                <span class="no-bold" v-text="t$('globalV1.headers.contactUs')"></span>
              </span>
            </template>
            <b-dropdown-form>
              <div class="d-flex justify-content-between">
                <button type="button" class="btn btn-white btn-sm ml-2" variant="white" @click="openWhatsApp">
                ...
                <button type="button" class="btn btn-white btn-sm mr-5" variant="white" @click="openMailTo">
                  <svg xmlns="http://www.w3.org/2000/svg" class="mt-n1" width="21" height="21" fill="var(--white)" viewBox="0 0 256 256">
                    <path
          ...
          >
            <template #button-content>
              <span class="navbar-dropdown-menu">
                ...
                <span class="d-lg-none" v-text="t$('global.menu.account.main')"></span>
              </span>
            </template>
      ...
      <div v-else class="headers-v1__loader"></div>
    </b-collapse>
  </b-navbar>
</template>
