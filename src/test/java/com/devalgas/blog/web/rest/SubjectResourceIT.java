...
class SubjectResourceIT {
    ...
    public static Subject createUpdatedEntity() {
        return new Subject().titleFr(UPDATED_TITLE_FR).titleEn(UPDATED_TITLE_EN);
    }
    ...
    void putExistingSubject() throws Exception {
        ...
        updatedSubject.titleFr(UPDATED_TITLE_FR).titleEn(UPDATED_TITLE_EN);
    ...
    void partialUpdateSubjectWithPatch() throws Exception {
        ...
        partialUpdatedSubject.titleFr(UPDATED_TITLE_FR);
    ...
    void fullUpdateSubjectWithPatch() throws Exception {
        ...
        partialUpdatedSubject.titleFr(UPDATED_TITLE_FR).titleEn(UPDATED_TITLE_EN);
