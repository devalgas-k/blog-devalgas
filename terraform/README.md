...
```
curl "http://localhost:8089/demo.tgz?iactool=TERRAFORM&region=francecentral&application=APP_SERVICE.standard&runtime=SPRING&database=POSTGRESQL.basic&addons=key_vault&gitops=true" | tar -xzvf -
```
